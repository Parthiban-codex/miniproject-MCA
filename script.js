...
function displayWeather(data){
    cityName.innerHTML=`<i class="fa-solid fa-location-dot"></i>${data.name}`;
...
let city=cityName.innerText.replace(
    "City Name",
    ""
).trim();
...
card.className="hour-card glass";
...
const box=document.getElementById("weeklyForecast");
...
const oldDisplayWeather3=displayWeather;
...
let rain=document.createElement(
"div"
);
...
let drop=document.createElement(
"span"
);
...
let snow=document.createElement(
"div"
);
...
let flake=document.createElement(
"span"
);
